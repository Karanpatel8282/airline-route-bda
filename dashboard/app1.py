...
# ============================================================
# GLOBAL PLOTLY THEME (ASTRA / aviation palette)
# ============================================================

pio.templates["astra"] = go.layout.Template(
    layout=go.Layout(
        paper_bgcolor="rgba(0,0,0,0)",
        plot_bgcolor="rgba(0,0,0,0)",
        font=dict(family="Inter, sans-serif", color="#DCEAF7", size=13),
        title=dict(font=dict(size=17, color="#F4F8FC", family="Space Grotesk, sans-serif")),
        colorway=[
            "#F0B429", "#55C7F5", "#4FD1C5", "#FF7F6B",
            "#8C7AE6", "#3AD29F", "#E8618C", "#63B3ED"
        ],
        xaxis=dict(
            gridcolor="rgba(85,199,245,0.08)",
            linecolor="#1A4564",
            zerolinecolor="#1A4564",
            tickfont=dict(color="#8FA9BF")
        ),
        yaxis=dict(
            gridcolor="rgba(85,199,245,0.08)",
            linecolor="#1A4564",
        ...
        hoverlabel=dict(bgcolor="#0D243B", font_color="#F4F8FC", bordercolor="#1A4564")
    )
)

px.defaults.template = "astra"
...
st.markdown(
    ...
    .stApp {
        background:
            radial-gradient(circle at 15% 10%, rgba(85, 199, 245, 0.07), transparent 42%),
            radial-gradient(circle at 85% 0%, rgba(240, 180, 41, 0.06), transparent 38%),
            repeating-linear-gradient(0deg, rgba(255,255,255,0.015) 0px, rgba(255,255,255,0.015) 1px, transparent 1px, transparent 46px),
            repeating-linear-gradient(90deg, rgba(255,255,255,0.015) 0px, rgba(255,255,255,0.015) 1px, transparent 1px, transparent 46px),
            #060F1C;
        background-attachment: fixed;
    }

    h1, h2, h3, .main-title, .sidebar-brand, .section-title {
    ...
    .hero-wrap {
        ...
        margin-bottom: 6px;
        border-radius: 20px;
        background: linear-gradient(135deg, rgba(16,42,67,0.55), rgba(7,21,37,0.15));
        border: 1px solid #173B57;
        overflow: hidden;
    }
    ...
    .hero-wrap::before {
        ...
        left: -5%;
        width: 110%;
        border-top: 2px dashed rgba(85, 199, 245, 0.22);
    }
    ...
    .main-title {
        ...
        background: linear-gradient(90deg, #F4F8FC, #55C7F5);
    ...
    div[role="radiogroup"] label:has(input:checked) {
        background: linear-gradient(90deg, rgba(240,180,41,0.16), rgba(85,199,245,0.08));
    ...
    .kpi-card::before {
        ...
        height: 3px;
        background: linear-gradient(90deg, #F0B429, #55C7F5, #3AD29F);
    }
...
st.markdown(
    """
    <div class="hero-wrap">
        <div class="main-title"><span class="plane-icon">✈️</span>ASTRA</div>
